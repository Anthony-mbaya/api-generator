...
export const Quote =()=> {
  ...
  return (
    <div className="cont">
      <button onClick={fetchApiFun} className="btn">
        Generate Quote
      </button>
      <div
        style={{ color: "#c2bfbf", backgroundColor: backgroundColor }}
        className="quote-box"
      >
...
function Quote(){
    ...
    return( 
        <>
        <div className='btnwrapper'><button onClick={fetchApiFun} className='btn' >Generate Quote</button></div>
...
>>>>>>> 3dd8e6a14f0aa5df178eac809542205b31526d5c
}
